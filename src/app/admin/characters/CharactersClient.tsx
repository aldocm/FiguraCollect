...
import { ArrowLeft, Search, Plus, Trash2, User, Box, X, Save, Edit2, ChevronDown, Loader2 } from 'lucide-react'
...
export default function CharactersClient() {
  ...
  const handleEdit = async (c: Character) => {
    setLoadingEdit(true)
    setEditingId(c.id)
                          ...
                          >
                            <div className="relative">
                              <motion.div
                                ...
                                className="p-4 bg-cyan-500/20 rounded-2xl"
                              >
                              ...
                              <motion.div
                                ...
                                className="absolute -inset-2 bg-cyan-500/10 rounded-3xl -z-10"
                              />
                            </div>
